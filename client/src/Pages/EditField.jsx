...
import { getImageUrl } from "../utils/getImageUrl"; // ✅ Import pour l'image actuelle
...
export default function EditField() {
  ...
  const [form, setForm] = useState({
    ...
    length: "",
    width: "",
    photo: null, // ✅ pour nouvelle image
  });

  const [preview, setPreview] = useState(""); // ✅ pour afficher l’image actuelle ou nouvelle
  ...
  return (
    <Container
      maxWidth="sm"
      sx={{ mt: 5, backgroundColor: "#ffffff", p: 4, borderRadius: 4 }}
    >
      <Typography
        variant="h4"
        align="center"
